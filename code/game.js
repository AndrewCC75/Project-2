...
function Vhazard(pos) {
  this.basePos = this.pos =pos.plus(new Vector(0.2, 2));
  this.size = new Vector(0.6, 0.6);
  this.wobble = Math.random() * Math.PI * 2;
}
Vhazard.prototype.type = "vhazard";
...
var hazardwobbleSpeed = 2, hazardwobbleDist = 2;

Hazard.prototype.act = function(step) {
  this.wobble += step * hazardwobbleSpeed;
  var hazardwobblePos = Math.sin(this.wobble) * hazardwobbleDist;
  this.pos = this.basePos.plus(new Vector(0, hazardwobblePos));
};

var vhazardwobbleSpeed = 8, vhazardwobbleDist = 2;

Vhazard.prototype.act = function(step) {
  this.wobble += step * vhazardwobbleSpeed;
  var vhazardwobblePos = Math(this.wobble) * vhazardwobbleDist;
  this.pos = this.basePos.plus(new Vector(0, vhazardwobblePos));
};
